...
class Preprocess:
    ...
    def load_data_from_file(self, file_name, is_train=True):
        ...
        self.args.n_questions = len(
            np.load(os.path.join(self.args.data_dir, "assessmentItemID_classes.npy"))
        )
        self.args.n_test = len(
            np.load(os.path.join(self.args.data_dir, "testId_classes.npy"))
        )
        self.args.n_tag = len(
            np.load(os.path.join(self.args.data_dir, "KnowledgeTag_classes.npy"))
        )
