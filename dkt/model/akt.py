"""Implementation of "TContext-Aware Attentive Knowledge Tracing"
    https://dl.acm.org/doi/pdf/10.1145/3394486.3403282

    Ref: https://github.com/arghosh/AKT
"""
import torch
...
class AKT(nn.Module):
    def __init__(self, args):
        ...
        """
        self.n_question = args.n_questions
        ...
        self.model = Architecture(
            ...
            d_model=hidden_dim,
            d_feature=hidden_dim / args.n_heads,
            d_ff=args.ff_dim,
        ...
        self.out = nn.Sequential(
            nn.Linear(hidden_dim + embed_l, args.final_fc_dim),
            nn.ReLU(),
...
class MultiHeadAttention(nn.Module):
    def __init__(
        self, d_model, d_feature, n_heads, dropout, kq_same, device, bias=True
    ):
        super().__init__()
        """
    ...
    def forward(self, q, k, v, mask, zero_pad):
        ...
        gammas = self.gammas
        scores = attention(
            q, k, v, self.d_k, mask, self.dropout, zero_pad, self.device, gammas
        )
